...
import { IRemasLikeController } from "./interfaces/remasLike";
import { IRemasLikeService } from "../../services/interfaces/remasLike";
@injectable()
class RemasLikeController implements IRemasLikeController {

    constructor(
        @inject(TYPES.RemasLikeService) private likeService: IRemasLikeService
    ) { }
...
export default RemasLikeController
