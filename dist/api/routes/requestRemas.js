...
let RequestRemasRouter = class RequestRemasRouter extends baseRouter_1.default {
    requestRemasController;
    router;
    constructor(requestRemasController) {
        super();
        this.requestRemasController = requestRemasController;
...
RequestRemasRouter = __decorate([
    inversify_1.injectable(),
    __param(0, inversify_1.inject(types_1.TYPES.RequestRemasController))
], RequestRemasRouter);
exports.default = RequestRemasRouter;
