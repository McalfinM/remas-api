...
let RemasLikeRouter = class RemasLikeRouter extends baseRouter_1.default {
    likeController;
    router;
...
RemasLikeRouter = __decorate([
    inversify_1.injectable(),
    __param(0, inversify_1.inject(types_1.TYPES.RemasLikeController))
], RemasLikeRouter);
exports.default = RemasLikeRouter;
