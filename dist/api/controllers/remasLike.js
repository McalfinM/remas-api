...
let RemasLikeController = class RemasLikeController {
    likeService;
...
RemasLikeController = __decorate([
    inversify_1.injectable(),
    __param(0, inversify_1.inject(types_1.TYPES.RemasLikeService))
], RemasLikeController);
exports.default = RemasLikeController;
