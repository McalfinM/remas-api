...
let RequestRemasController = class RequestRemasController {
    requestRemasService;
    constructor(requestRemasService) {
        this.requestRemasService = requestRemasService;
    }
    create(req, res) {
        const like = new createRequestRemas_1.default(req.body);
        const user = req.user;
...
RequestRemasController = __decorate([
    inversify_1.injectable(),
    __param(0, inversify_1.inject(types_1.TYPES.RequestRemasService))
], RequestRemasController);
exports.default = RequestRemasController;
