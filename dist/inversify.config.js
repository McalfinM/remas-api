...
const event_1 = __importDefault(require("./api/routes/event"));
const event_2 = __importDefault(require("./api/controllers/event"));
const event_3 = __importDefault(require("./repositories/event"));
const event_4 = __importDefault(require("./services/event"));
const requestRemas_1 = __importDefault(require("./api/routes/requestRemas"));
const requestRemas_2 = __importDefault(require("./api/controllers/requestRemas"));
const requestRemas_3 = __importDefault(require("./services/requestRemas"));
const requestRemas_4 = __importDefault(require("./repositories/requestRemas"));
const user_4 = __importDefault(require("./api/routes/user"));
...
container.bind(types_1.TYPES.UserRouter).to(user_4.default).inSingletonScope();
...
container.bind(types_1.TYPES.EventRouter).to(event_1.default).inSingletonScope();
container.bind(types_1.TYPES.EventController).to(event_2.default).inSingletonScope();
container.bind(types_1.TYPES.EventService).to(event_4.default).inSingletonScope();
container.bind(types_1.TYPES.EventRepository).to(event_3.default).inSingletonScope();
container.bind(types_1.TYPES.RequestRemasRouter).to(requestRemas_1.default).inSingletonScope();
container.bind(types_1.TYPES.RequestRemasController).to(requestRemas_2.default).inSingletonScope();
container.bind(types_1.TYPES.RequestRemasService).to(requestRemas_3.default).inSingletonScope();
container.bind(types_1.TYPES.RequestRemasRepository).to(requestRemas_4.default).inSingletonScope();
